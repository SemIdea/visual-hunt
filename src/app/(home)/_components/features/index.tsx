    ...
    <section className="container mx-auto px-4 py-20 md:py-32">
      ...
      <div className="mb-32 grid items-center gap-12 md:grid-cols-2">
        <div>
          ...
          <p className="text-lg leading-relaxed text-muted-foreground">
            Don&apos;t settle for one opinion. VisualHunt queries multiple
            search databases to find matches that other tools miss, giving you
      ...
      <div className="grid items-center gap-12 md:grid-cols-2">
        ...
        <div className="order-1 md:order-2">
          ...
          <p className="text-lg leading-relaxed text-muted-foreground">
            Stop guessing from screenshots. Upload a video clip, and our tool
            will analyze individual frames to pinpoint the exact source.
          </p>
        </div>
      </div>
    </section>
